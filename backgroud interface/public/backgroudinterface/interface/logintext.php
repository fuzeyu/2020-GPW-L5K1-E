<?php
    ...
    if(!empty($username) && !empty($password))
    {
        ...
        if (!$con)
        {
            header("Location:/xyf/public/backgroudinterface/login.php?err=3");
        }
        ...
        { 
            header("Location:/xyf/public/backgroudinterface/login.php?err=1");
        }
    }
    else
    {
        header("Location:/xyf/public/backgroudinterface/login.php?err=2");
    }
